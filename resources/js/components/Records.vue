      ...
      <tbody>
        <tr v-for="item,i in records">
          ...
          <td>
            <input
              type="text"
              v-model="records[i].mat"
              class="form-control col-sm-9"
              @keyup.enter="addRec(i)"
            >
          </td>
          <td>
            <input
              type="number"
              v-model.number="records[i].qty"
              class="form-control col-sm-9"
              @keyup.enter="addRec(i)"
            >
          </td>
          <td>
            <input
              type="number"
              v-model.number="records[i].single"
              class="form-control col-sm-9"
              @keyup.enter="addRec(i)"
            >
          </td>
          <td>
            <input
              type="number"
              v-model.number="records[i].total"
              class="form-control col-sm-9"
              @keyup.enter="addRec(i)"
            >
          </td>
